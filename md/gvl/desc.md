...
wi=exp⁡(−∥yi−ytarget∥22σ2)w_i = \exp\left(-\frac{\|y_i - y_{target}\|^2}{2\sigma^2}\right)wi​=exp(−2σ2∥yi​−ytarget​∥2​)
...
Metryka FID ↓Generated vs SzpitalAAPM vs SzpitalStd-FID (sieć ogólna, ImageNet)85,5115,6Med-FID (sieć medyczna, RadImageNet)949 372707 101Sino-FID (statystyki sinogramu)93,88 102

Dwie z trzech metryk (Std-FID, Sino-FID) wskazują, że Generated jest bliżej danych klinicznych niż AAPM jest bliżej tych danych. Med-FID — metryka oparta na sieci trenowanej specjalnie na obrazach medycznych — nie potwierdza tego efektu, co opisujemy jako wynik niejednoznaczny wymagający dalszej analizy.